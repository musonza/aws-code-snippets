...
exports.handler = function (event, context) {
    ...
    var _sizesArray = [_2000px, _1000px, _300px, _150px]
    ...
    async.forEachOf(_sizesArray, function (value, key, callback) {
        async.waterfall([
                ...
                gm(response.Body).antialias(true).density(
                    300).toBuffer('JPG', function (err,
                        ...
                        if (err) {
                            ...
                            console.timeEnd(
                                "convertImage");
                            next(null, buffer, response.ContentType);
                            //next(null, 'done');
                        }
                    });
            },
            function process(response, contentType, next) {
            ...
            function upload(data, contentType, index, next) {
                ...
                s3.putObject({
                    ...
                    Body: data,
                    ContentType: contentType, //data.mimetype,
                    ACL: 'public-read'  //'JPG'
                }, next);
